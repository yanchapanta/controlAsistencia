...
             & time; call an element "x"
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <table class="table table-hover table-responsive-md border border-dark" width="50%" border="0" align="center">
                ...
                <td class="text-center">           
                    ...
                    <div class="badge badge-warning" >
                        <a href="bottom_opcion/tabla_consultar_si.php?id=<?php echo $personas->id ?> & ci=<?php echo $personas->ci ?> & nom=<?php echo $personas->nombre ?> & ape=<?php echo $personas->apellido ?> & dir=<?php echo $personas->asistencia ?>">
                            <input   type='button' name='btn_si' id='del' value='si'>
                        </a>
                        <a href="bottom_opcion/tabla_consultar_no.php?id=<?php echo $personas->id ?> & ci=<?php echo $personas->ci ?> & nom=<?php echo $personas->nombre ?> & ape=<?php echo $personas->apellido ?> & dir=<?php echo $personas->asistencia ?>">
                ...
                <td class="bot">
                    <a href="tabla/tabla_consultar_borrar.php?id=<?php echo $personas->id ?>">
                        <input type='button' name='del' id='del' value='Borrar'>
                    </a>
                </td>
                
                <td class='bot'>
                    <a href="tabla/tabla_consultar_editar.php?id=<?php echo $personas->id ?> & ci=<?php echo $personas->ci ?> & nom=<?php echo $personas->nombre ?> & ape=<?php echo $personas->apellido ?> & dir=<?php echo $personas->asistencia ?>">
