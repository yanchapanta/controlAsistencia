   ...
   <!-- main tittle -->
    ...
    <div class="row justify-content-center">
        ...
        <?php
            ...
            //--------------------------------pasted page-------------------
            $tamanio_paginas=15;//1
                if(isset($_GET["pagina"])){
                    
                        if($_GET["pagina"]==0){
                            header("Location:invitado_consultar01.php");
                        }else{
        ...
        <table class="table table-hover table-responsive-sm fixed border border-dark"  width="50%" border="0" align="center">
            ...
            <td class="text-center">           
                ...
                <div class="badge badge-warning" >
                    <a href="bottom_opcion/invitado_tabla_consultar_si01.php?id=<?php echo $personas->id ?> & ci=<?php echo $personas->ci ?> & nom=<?php echo $personas->nombre ?> & ape=<?php echo $personas->apellido ?> & dir=<?php echo $personas->asistencia ?>">
                        <input   type='button' name='btn_si' id='del' value='si'>
                    </a>
                    <a href="bottom_opcion/invitado_tabla_consultar_no01.php?id=<?php echo $personas->id ?> & ci=<?php echo $personas->ci ?> & nom=<?php echo $personas->nombre ?> & ape=<?php echo $personas->apellido ?> & dir=<?php echo $personas->asistencia ?>">
